...
public class ATM extends JFrame {
	...
	protected void buildApp() {
		...
		// ==================================
		// 3 Withdraw buttons (Simply minus from balance if balance is not below
		// ammount):
		...
		// Deposit Button - Primes program for a deposit, allows user to click enter
		// deposit
		...
		enter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				if (readyToEnter == true) {
					...
					displayArea.setText(
							"<html> You have not yet chosen an action! <br><br>" + finishedTransaction() + "</html>");
					clearInput();
					inputDisplay.setText("Input Display: ");
				}
