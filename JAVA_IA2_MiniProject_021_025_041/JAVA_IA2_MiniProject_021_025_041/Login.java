...
public class Login extends JFrame {
	...
	void buildApp(){
		...
		JButton regPin = new JButton("Register");
		...
		regPin.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event){
			...
			public void actionPerformed(ActionEvent event) {
				...
				} else
				{
					if(attempts != 1){
						...
						+ " attempts remaining!");
						JOptionPane.showConfirmDialog(new Register(), new JButton("Register new Account?"));
